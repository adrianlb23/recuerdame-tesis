...
export default function Mujer() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const { data } = await api.get("/api/catalogo/mujer");
  ...
  const handleDelete = async (numero) => {
    ...
    if (!ok) return;
    try {
      await api.delete(`/api/admin/catalogo/mujer/${numero}`);
    ...
    <main className="modern-main">
      <section className="hero-section">
        ...
        <p className="hero-description">
          Fragancias femeninas inspiradas en las tendencias olfativas más populares
        </p>
      </section>
      ...
      <div className="filter-options-container" id="filter-options">
        <div className="filter-grid">
          {[
            "Verde","Frutal","Citrico","Amaderado","Floral",
            "Floral blanco","Atalcado","Dulce","Avainillado",
            "Fresco especiado","Calido especiado","Ambarado",
          ].map((opt) => (
